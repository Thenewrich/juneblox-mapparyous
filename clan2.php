...
<span class="clan-title"><?php echo $clanRow['name']; ?>
</span><b> [<?php echo $clanRow['tag']; ?>]</b>
</div>
...
Owned by
<b>
<a href="/user/<?php echo $ownerRow['id']; ?>/" class="black-text"><?php echo $ownerRow['username']; ?></a>
</b>
</div>
<div><?php echo $clanRow['members']; ?> Members</div>
</div>
</div>
<div class="col-9-12">
<div class="clan-description darkest-gray-text bold">
<span><?php echo $clanRow['description']; ?></span>
              <?php
              if($loggedIn) {
                if($power >= 2) {
...
Members
          ...
          <div id="members"></div>
           ...
           <div id="box" style="padding:5px; margin-top:5px;">
        <div style="text-align:center">
          <div style="text-align:left;">
            
             <?php
              echo 'Brick Funds: '.$clanRow['funds'].''
               ?>
